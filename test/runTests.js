...
describe("ReadText Stream Test", function() {
  describe("ReadText Stream number of lines and total length in bytes", function() {
  ...
  describe("ReadText Stream number of lines and total length in bytes", function() {
    const ReadTextStream = new ReadText();
    it("should return 1 line and 3 bytes when text is Hii", function() {
  ...
  describe("ReadText Stream number of lines and total length in bytes", function() {
    const ReadTextStream = new ReadText();
    it("should return 2 lines and 15 bytes when text is Hii\\nHello hello", function() {
      ReadTextStream.write("Hii\nHello hello");
      assert.equal(
        ReadTextStream.obj.number_of_lines,
        2,
  ...
  describe("ReadText Stream number of lines and total length in bytes in Chinese", function() {
    const ReadTextStream = new ReadText();
    it("should return 1 lines and 15 bytes when text is ⺄⺅⺇⺋⺋", function() {
      ReadTextStream.write("⺄⺅⺇⺋⺋");
      assert.equal(
        ReadTextStream.obj.number_of_lines,
        1,
...
describe("SummaryReport Stream Test", function() {
  ...
  describe("SummaryReport Stream Read Lines and Growth Rate", function() {
    const obj = {
  ...
  describe("SummaryReport Stream Read Lines and Growth Rate", function() {
    ...
    it(`should return ${obj.number_of_lines} lines read and growth of file is ${(obj.total_length_in_bytes/(obj.elapsed_time/1000)).toFixed(2)} bytes/s when the input is empty`, function() {
      const SummaryReportStream = new SummaryReport();
      SummaryReportStream.write(obj);
      const msg = SummaryReportStream.read().toString()
      assert.equal(
        msg,
        `${obj.number_of_lines} lines read and growth of file is ${(obj.total_length_in_bytes/(obj.elapsed_time/1000)).toFixed(2)} bytes/s\n`,
  ...
  describe("SummaryReport Stream Read Lines and Growth Rate", function() {
    ...
    it(`should return 10 lines and ${(obj.total_length_in_bytes/(obj.elapsed_time/1000)).toFixed(2)} bytes/s when the input is empty`, function() {
      const SummaryReportStream = new SummaryReport();
      SummaryReportStream.write(obj);
      const msg = SummaryReportStream.read().toString()
      assert.equal(
        msg,
        `${obj.number_of_lines} lines read and growth of file is ${(obj.total_length_in_bytes/(1)).toFixed(2)} bytes/s\n`,
        "lines or growth of file incorrect"
      );
    });
  });
